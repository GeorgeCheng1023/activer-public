...
import dummySearchData from './dummySearcData.json';
...
function Search() {
  return (
    <>
      ...
      />
       <SearchPopup
        defaultTagsRecommend={dummySearchData.RecommendTags}
        defaultKeyword={dummySearchData.Keyword}
        defaultTagsStorage={dummySearchData.}
      />)}
